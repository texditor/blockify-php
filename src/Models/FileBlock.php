...
use Texditor\Blockify\Interfaces\FileBlockInterface;

class FileBlock extends BlockModel implements FileBlockInterface
{
    protected string $inputName = 'file';
     ...
     * @var bool
     */
    protected bool $isLinkStrategy = false;
    ...
    protected function renderFiles(array $block, string $additionalCss = ''): string
    {
        ...
        foreach ($block['data'] as $item) {
            $itemsHtml[] = $this->renderFileItem($item);
        }
